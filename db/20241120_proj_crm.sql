...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th10 20, 2024 lúc 02:45 PM
...
('673de73cf0b5390cf', 0, '2e537321019cee0b9144097425d88477', 'rsvtaGD5S88p8MYVXrJGjQPeFuFsGqaOVcuegVVLrspqDA4Q/St2iHbCko6V/upm8JfQeHpRxWY0eF9Rkk2Qi1', 'd342548b3998c6eac9d3e50005317d7b', '::1', 1, '2024-11-20 13:45:14', '2024-11-20 13:42:20', '2024-11-20 13:45:14', '671fa89eeaf93e223', NULL);
...
DROP TABLE IF EXISTS `c_driving_course`;
CREATE TABLE IF NOT EXISTS `c_driving_course` (
  `id` varchar(17) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deleted` tinyint(1) DEFAULT 0,
  `description` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `c_fee_payment`;
CREATE TABLE IF NOT EXISTS `c_fee_payment` (
  `id` varchar(17) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deleted` tinyint(1) DEFAULT 0,
  `description` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `IDX_MODIFIED_BY_ID` (`modified_by_id`),
  KEY `IDX_ASSIGNED_USER_ID` (`assigned_user_id`),
  KEY `IDX_DRIVING_COURSE_ID` (`driving_course_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `IDX_WORKING_TIME_CALENDAR_ID` (`working_time_calendar_id`),
  KEY `IDX_LAYOUT_SET_ID` (`layout_set_id`),
  KEY `IDX_C_GIAOVIENHUONGDAN_ID` (`c_giaovienhuongdan_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
