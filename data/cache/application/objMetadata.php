...
return (object) [
  ...
  'entityDefs' => (object) [
    ...
    'CDrivingCourse' => (object) [
      'fields' => (object) [
        ...
        'tonghocphiConverted' => (object) [
          'type' => 'currencyConverted',
          'readOnly' => true,
          'importDisabled' => true,
          'customizationInlineEditDisabledDisabled' => true
        ],
        'hocphidanapCurrency' => (object) [
          'readOnly' => true,
          'type' => 'enum',
          'view' => 'views/fields/currency-list',
          'layoutDetailDisabled' => true,
  ...
  'selectDefs' => (object) [
    ...
    'User' => (object) [
      ...
      'primaryFilterClassNameMap' => (object) [
        ...
        'teacher' => 'Espo\\Custom\\Classes\\Select\\UserObj\\PrimaryFilters\\Teacher',
        'student' => 'Espo\\Custom\\Classes\\Select\\UserObj\\PrimaryFilters\\Student'
      ],
      'boolFilterClassNameMap' => (object) [
  ...
  'formula' => (object) [
    'CDrivingCourse' => (object) [
      'beforeSaveCustomScript' => 'name = string\\concatenate(assignedUser.name, \' - \', string\\concatenate(hangthi));
hocphidanap = entity\\sumRelated(\'feePayments\', \'money\');

'
    ],
    'CFeePayment' => (object) [
      'beforeSaveCustomScript' => 'parent.hocphidanap = entity\\sumRelated(\'feePayments\', \'money\');'
    ]
  ]
];
